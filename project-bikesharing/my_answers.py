...
class NeuralNetwork(object):
    ...
    def forward_pass_train(self, X):
        ...
        # We're dealing with a regression so this needs to be a linear.
        # Had we been dealing with a classification issue we'd use something like
        # the sigmoid activation function or softmax.
